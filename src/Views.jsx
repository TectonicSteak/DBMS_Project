...
import { SemReports, DeleteAttendance, Report, Attendance, UpdateMarks, UpdateAttendance, StudentProfile, TeacherProfile, StudentDashboard, TeacherDashboard, Marks, MarkReport } from './pages/views'
        ...
        <>
            <Routes>
                ...
                <Route element={<StudentProtectedRoutes />}>
                    ...
                    <Route path="/student_dashboard/marks" element={<Marks />} />
